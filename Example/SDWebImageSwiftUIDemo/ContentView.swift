...
struct FastSwitchGifView: View {
    let fileName: String

    // if gifURL is null, will not play animation
//    @State private var gifURL: URL?
    @State private var gifURL: URL? = Bundle.main.url(forResource: "joy", withExtension: "gif")
    ...
    func switchToNewGif() {
        gifURL = Bundle.main.url(forResource: "dogflops", withExtension: "gif")
    }
}
...
struct ContentView: View {
    ...
    func contentView() -> some View {
        List {
            FastSwitchGifView(fileName: "joy")
